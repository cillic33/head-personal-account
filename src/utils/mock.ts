...
export const MEmployees: TTable = {
  settings: {
    employee: {name: "Сотрудник", width: 254, isEmployee: true},
    division: {name: "Подразделение", width: 220},
    ...
    grade: {name: "Грейд"},
    grossRate: {name: "Дн. брутто-ставка, ₽"},
    city: {name: "Город"},
    timeZone: {name: "Час. пояс"},
    profileStatus: {name: "Статус профиля"},
    nearestReleaseDate: {name: "Ближ. дата высвоб."},
    workExperienceIBS: {name: "Стаж работы (IBS)"},
    nearestPeriodAbsence: {name: "Ближ. период отсут."},
    tsStatus: {name: "Статус TS"},
    happinessIndex: {name: "Индекс счастья"},
    moodMonitoring: {name: "Мониторинг настроения"},
  },
  body: [
    {
      id: "1",
      ...
      division: {
        aa: "Группа клиентского сервиса",
        bb: "Группа клиентского сервиса",
      },

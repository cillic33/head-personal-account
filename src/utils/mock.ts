...
import {TTable, TTableTypes} from "@typing/TTable";
...
export const MEmployees: TTable = {
  settings: {
    ...
    profileStatus: {id: 'profileStatus', name: "Статус профиля", isCenter: true, type: TTableTypes.Chip},
    ...
    tsStatus: {id: 'tsStatus', name: "Статус TS", isCenter: true, type: TTableTypes.Chip},

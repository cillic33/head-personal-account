...
export const MEmployees: TTable = {
  settings: {
    employee: {name: "Сотрудник", width: 238, isEmployee: true},
    division: {name: "Подразделение", width: 204, isDivision: true},
    specialization: {name: "Специализация", width: 180},
    post: {name: "Должность"},
    direction: {name: "Направление"},
    technology: {name: "Технология"},
    lineManager: {name: "Лин. руководитель"},
    grade: {name: "Грейд", isCenter: true},
    grossRate: {name: "Дн. брутто-ставка, ₽", isCenter: true},
    city: {name: "Город"},
    timeZone: {name: "Час. пояс", isCenter: true},
    profileStatus: {name: "Статус профиля", isCenter: true, isStatus: true},
    nearestReleaseDate: {name: "Ближ. дата высвоб.", isCenter: true},
    workExperienceIBS: {name: "Стаж работы (IBS)", isCenter: true},
    nearestPeriodAbsence: {name: "Ближ. период отсут.", isCenter: true},
    tsStatus: {name: "Статус TS", isCenter: true, isStatus: true},
    happinessIndex: {name: "Индекс счастья", isCenter: true},
    moodMonitoring: {name: "Мониторинг настроения", isCenter: true},
  },
  body: [
    {
      id: "1",
